...
from costa.training.network_trainer import NetworkTrainer
...
class nnUNetTrainer(NetworkTrainer):
    ...
    def preprocess_patient(self, input_files):
        ...
        preprocessor_class = recursive_find_python_class([join(costa.__path__[0], "preprocessing")],
                                                         preprocessor_name,
                                                         current_module="costa.preprocessing")
    ...
    def validate(self, do_mirroring: bool = True, use_sliding_window: bool = True, step_size: float = 0.5,
        ...
        for f in subfiles(self.gt_niftis_folder, suffix=".nii.gz"):
            ...
            if not success:
                raise OSError(
                    f"Something went wrong while copying nifti files to {gt_nifti_folder}. See above for the trace.")
