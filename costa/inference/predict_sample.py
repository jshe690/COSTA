...
from costa.inference.predict import predict_from_folder
from costa.paths import default_plans_identifier, network_training_output_dir, default_cascade_trainer, default_trainer
...
def find_task_name_from_task_id(task_id, model):
...
def main():
    ...
    parser.add_argument('-m', '--model',
                        help="CErebrovaSculAR",
                        default="CESAR", required=False)
    ...
    parser.add_argument('-chk',
                        help='checkpoint name, default: model_best_checkpoint',
                        required=False,
                        default='model_best')
